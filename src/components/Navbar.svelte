        ...
        <div class="row d-flex w-100 p-0 m-0">
            <div class="col-auto p-0 pe-1">
                <div class="btn-group">
                    ...
                    <button class="btn btn btn-secondary d-md-block" aria-label="Toggle dark mode" on:click={() => toggleDarkMode()}>
            ...
            <div class="col p-0">
                <form class="d-flex" role="search" id="navbar-search-form">
                    <input id="navbar-search" class="form-control rounded-end-0" type="search" placeholder="Search pages..." aria-label="Search">
